...
@section('title', 'Luyện tập Hiragana')
                            ...
                            <div class="card practice-card h-100" data-character="{{ $character->character }}">
                                <div class="card-body text-center">
                                    ...
                                    <div class="character-display mb-3">
                                        <div class="japanese-character" style="font-size: 3rem; font-weight: bold; color: #4f46e5;">
                                            {{ $character->character }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="romaji-display mb-3">
                                        <span class="badge bg-primary fs-6">{{ $character->romaji }}</span>
                                    </div>
                            ...
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-md-3">
                                            <div class="stat-item">
                                                <div class="stat-number text-primary">{{ $characters->count() }}</div>
        ...
        button.addEventListener('click', async function() {
            ...
            try {
                ...
                if (window.unifiedAudio) {
                    await window.unifiedAudio.playCharacter(character, 'hiragana', { rate: selectedSpeed });
                    ...
                    await window.playCharacterAudio(character, 'hiragana', selectedSpeed);
                }
            } catch (error) {
