                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('level') is-invalid @enderror" 
                                ...
                                <option value="1" {{ old('level') == 1 ? 'selected' : '' }}>N5 - Cơ bản</option>
                                <option value="2" {{ old('level') == 2 ? 'selected' : '' }}>N4 - Sơ cấp</option>
                                <option value="3" {{ old('level') == 3 ? 'selected' : '' }}>N3 - Trung cấp</option>
                                <option value="4" {{ old('level') == 4 ? 'selected' : '' }}>N2 - Trung cao cấp</option>
                                <option value="5" {{ old('level') == 5 ? 'selected' : '' }}>N1 - Cao cấp</option>
                            </select>
                            @error('level')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
