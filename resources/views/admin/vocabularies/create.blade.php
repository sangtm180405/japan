...
@section('title', 'Thêm từ vựng mới')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('japanese') is-invalid @enderror" 
                                   id="japanese" name="japanese" value="{{ old('japanese') }}" required>
                            @error('japanese')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('hiragana') is-invalid @enderror" 
                                   id="hiragana" name="hiragana" value="{{ old('hiragana') }}" required>
                            @error('hiragana')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('katakana') is-invalid @enderror" 
                                   id="katakana" name="katakana" value="{{ old('katakana') }}">
                            @error('katakana')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('vietnamese') is-invalid @enderror" 
                                   id="vietnamese" name="vietnamese" value="{{ old('vietnamese') }}" required>
                            @error('vietnamese')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('example_translation') is-invalid @enderror" 
                                      id="example_translation" name="example_translation" rows="2">{{ old('example_translation') }}</textarea>
